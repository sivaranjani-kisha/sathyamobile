...
// Handle route events
    ...
    return (
        ...
        <div className="fixed inset-0 z-[9999] flex justify-center items-center bg-black bg-opacity-30">
          <div className="p-4 rounded-lg shadow-lg">
            ...
            {/* main div start */}
            <div className={`relative transition-opacity duration-300 ${initialLoading ? 'opacity-0 h-0 overflow-hidden' : 'opacity-100'}`} ref={containerRef} >
  ...
  className={`block ${navigating ? 'pointer-events-none opacity-50' : ''}`}
>
